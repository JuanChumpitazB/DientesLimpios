...
namespace DientesLimpios.Pruebas.Dominio.ObjetosDeValor
{
    ...
    public class IntervaloDeTiempoTests
    {
        ...
        {
            new IntervaloDeTiempo(DateTime.UtcNow, DateTime.UtcNow.AddDays(-1)); // Fecha hoy - Fecha de ayer
        }
        [TestMethod]
        public void Constructor_ParametrosCorrectos_NoLanzaExcepcion()
        {
            new IntervaloDeTiempo(DateTime.UtcNow, DateTime.UtcNow.AddMinutes(30)); // Fecha hoy - Fecha de dentro de 30 minutos
        }
    }
}
